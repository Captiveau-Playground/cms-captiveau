      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-foreground mb-6">
          <VerticalCutReveal
            ...
            containerClassName="text-foreground leading-[120%] text-center justify-center items-center"
          >
            {
              "Bergerak dari Semangat, Tumbuh Bersama Inovasi Digital"
            }
          </VerticalCutReveal>
        </h2>
        ...
        >
          Berawal dari keyakinan bahwa setiap bisnis berhak mendapatkan solusi digital berkualitas,
          Captiveau hadir untuk menjembatani ide brilian dengan eksekusi teknis yang mumpuni.
          Setiap project adalah buah kolaborasi erat — memastikan hasil yang melampaui ekspektasi.
        </TimelineContent>
        ...
        >
          <a
            href="/services"
            className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 text-white flex items-center gap-2 hover:gap-4 transition-all duration-300 ease-in-out px-5 py-3 rounded-full cursor-pointer"
          >
            Jelajahi Layanan Kami <ArrowRight className="" />
          </a>
        </TimelineContent>
      </div>
