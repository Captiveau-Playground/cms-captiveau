          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-4">
                  <div>
                    <Input id="firstName" name="firstName" placeholder="First name"
                      ...
                      className="dark:bg-background h-9 shadow-xs" required />
                  </div>
                  <div>
                ...
                <div>
                  <Input id="email" name="email" placeholder="youremail@website.com" type="email"
                ...
                <div>
                  <Textarea id="message" name="message" placeholder="Let us know about your project"
                    value={formData.message} onChange={handleChange}
                    className="h-20 resize-none dark:bg-background shadow-xs" required />
                </div>
                <div className="flex items-center gap-3">
                  <Checkbox id="terms" checked={formData.terms}
                    onCheckedChange={handleCheckboxChange} required />
                  <Label htmlFor="terms" className="text-sm font-normal text-primary select-none">
