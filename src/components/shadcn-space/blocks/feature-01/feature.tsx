        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-8 md:gap-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6">
              ...
              >
                <Card className="flex items-start gap-12 pt-6 sm:py-10 border-none shadow-none ring-0 rounded-lg">
                  <CardContent className="flex flex-col gap-6 px-6 sm:px-8">
                    ...
                    <h3 className="text-xl sm:text-2xl font-medium">
                      &ldquo;Before Shadcn Space, we stitched UIs together from random
