...
const accordionTriggerVariants = cva([
  "flex w-full items-center justify-between gap-4 border-0 bg-transparent px-5 py-5 text-left sm:px-6",
...
const accordionTextVariants = cva(
  "m-0 px-5 pb-5 text-muted-foreground text-sm leading-[1.6] sm:px-6"
);
